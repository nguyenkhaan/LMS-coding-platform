...
def print_banner():
    ...
    table.add_row("URL", "[link=http://localhost:4002]http://localhost:4002[/link]")
    table.add_row("API Docs", "[link=http://localhost:4002/docs]http://localhost:4002/docs[/link] [dim](Swagger UI)[/dim]")
