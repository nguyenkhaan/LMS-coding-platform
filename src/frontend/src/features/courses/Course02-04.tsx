...
import { FigmaWriteReviewForm } from './components/FigmaWriteReviewForm';
import { FigmaFooter } from './components/FigmaFooter';

export const CourseReviewsWriteFigma: React.FC = () => {
			...
			<div className="w-full max-w-[1892px] bg-white shadow-2xl rounded-3xl border border-neutral-100 overflow-hidden flex flex-col">
				...
				<div className="w-full max-w-[1296px] mx-auto px-4 py-10 flex flex-col lg:flex-row gap-8 items-start">
					...
					<div className="flex-1 flex flex-col gap-6">
						...
						{/* Sections layout: Renders Reviews Form */}
					...
					<FigmaDetailSidebar
						...
						isPaid={true}
						hasReviewed={true} /* True so we don't render write review link inside write review form page again */
						courseSlug={slug}
					/>
				</div>
