				...
				<div className="flex-1 w-full flex flex-col gap-6">
					...
					{isEnrolled ? (
						...
						<div className="w-[940px] bg-white rounded-2xl border border-slate-100 p-8 shadow-sm text-center flex flex-col items-center gap-4">
							<div className="size-12 rounded-full bg-rose-50 flex items-center justify-center text-accent">
							...
							<button 
								...
								className="mt-2 px-6 py-2.5 bg-primary text-white rounded-lg text-sm font-semibold hover:bg-primary-hover transition-all cursor-pointer"
							>
								Enroll in Course
							</button>
						</div>
