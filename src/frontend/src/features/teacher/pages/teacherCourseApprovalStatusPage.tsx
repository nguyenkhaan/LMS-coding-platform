        ...
        <div className="w-full max-w-[1340px] mx-auto px-4 py-10 flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="flex-1 w-full flex flex-col gap-6 min-w-0">
            ...
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
              <h2 className="text-[18px] font-bold text-primary">Review Status simulator</h2>
              <div className="flex items-center gap-2">
                <span className="text-[12px] text-neutral-500 font-semibold">Change Simulated Status:</span>
                <select
                  value={status}
                  onChange={(e) => setStatus(e.target.value as CourseStatus)}
                  className="px-3 py-1.5 border border-gray-200 rounded-xl text-[13px] font-bold text-zinc-700 focus:outline-none focus:border-primary cursor-pointer bg-white"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
              ...
              <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-200 shadow-sm p-6 flex flex-col gap-5">
                <div>
                  <h3 className="text-[16px] font-bold text-zinc-900">Status Timeline</h3>
                  <p className="text-[13px] text-neutral-500 mt-0.5">Approval progress log</p>
                </div>
                ...
                <div className="relative pl-6 border-l-2 border-slate-100 flex flex-col gap-6 py-1">
                  ...
                  <div className="relative">
                    ...
                    <div>
                      <p className="text-[13px] font-semibold text-zinc-900">Draft Creation</p>
                      <p className="text-[11px] text-neutral-500">Course information saved as draft</p>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div>
                      <p className={`text-[13px] font-semibold ${
                        status === 'PENDING_REVIEW' ? 'text-amber-600' : 'text-zinc-900'
                      }`}>
                        Admin Moderation Review
                      </p>
                      <p className="text-[11px] text-neutral-500">Checks checklist guidelines</p>
                    </div>
                  </div>
                ...
                <div className="bg-slate-50/70 border border-gray-100 rounded-2xl p-4 flex flex-col gap-3">
                  <h4 className="text-[13px] font-bold text-zinc-900 uppercase tracking-wide">Admin Review details</h4>
              ...
              <div className="lg:col-span-3 bg-white rounded-2xl border border-gray-200 shadow-sm p-6 flex flex-col gap-5">
                <div>
                  <h3 className="text-[16px] font-bold text-zinc-900">Course Summary</h3>
                  <p className="text-[13px] text-neutral-500 mt-0.5">Overview of builder elements</p>
                </div>

                {/* Course stats grid */}
                <div className="grid grid-cols-2 gap-4 border-b border-gray-100 pb-4">
                  <div className="flex flex-col gap-0.5">
                    <span className="text-[11px] font-bold text-neutral-500 uppercase tracking-wide">Title</span>
                    <span className="text-[14px] font-bold text-zinc-900 truncate">{course.title}</span>
                  </div>
                  <div className="flex flex-col gap-0.5">
                    <span className="text-[11px] font-bold text-neutral-500 uppercase tracking-wide">Base Price</span>
                    <span className="text-[14px] font-bold text-primary">${course.price.toFixed(2)} USD</span>
                  </div>
                  <div className="flex flex-col gap-0.5">
                    <span className="text-[11px] font-bold text-neutral-500 uppercase tracking-wide">Modules Count</span>
                    <span className="text-[14px] font-semibold text-zinc-700">{course.sectionsCount} Sections</span>
                  </div>
                  <div className="flex flex-col gap-0.5">
                    <span className="text-[11px] font-bold text-neutral-500 uppercase tracking-wide">Lessons Count</span>
                    <span className="text-[14px] font-semibold text-zinc-700">{course.lessonsCount} Lessons</span>
                  </div>
                </div>

                {/* Submission Checklist */}
                <div className="flex flex-col gap-3">
                  <h4 className="text-[13px] font-bold text-zinc-900 uppercase tracking-wide">Readiness Checklist</h4>
                ...
                <div className="border-t border-gray-100 pt-4 flex flex-col sm:flex-row gap-3">
                  <button
                    ...
                    className="flex-1 py-2.5 rounded-xl border border-gray-200 text-[14px] font-semibold text-zinc-700 hover:bg-slate-50 flex items-center justify-center gap-1.5 cursor-pointer"
                  >
                  ...
                  {status === 'DRAFT' && (
                    <button
                      ...
                      className="flex-1 py-2.5 rounded-xl bg-primary text-white text-[14px] font-semibold hover:bg-primary-hover flex items-center justify-center gap-1.5 cursor-pointer"
                    >
                  ...
                  {status === 'PENDING_REVIEW' && (
                    <button
                      ...
                      className="flex-1 py-2.5 rounded-xl bg-rose-50 border border-rose-200 text-accent text-[14px] font-semibold hover:bg-rose-100/50 flex items-center justify-center gap-1.5 cursor-pointer"
                    >
                  ...
                  {status === 'REJECTED' && (
                    <button
                      ...
                      className="flex-1 py-2.5 rounded-xl bg-accent text-white text-[14px] font-semibold hover:bg-accent-hover flex items-center justify-center gap-1.5 cursor-pointer"
                    >
                      <RefreshCw className="w-4 h-4" />
                      Adjust & Resubmit
                    </button>
