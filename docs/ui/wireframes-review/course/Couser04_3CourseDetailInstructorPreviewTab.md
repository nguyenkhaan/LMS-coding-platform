...
- **Tên màn hình:** COURSE04.3 Course Detail Instructor Preview
- **Đường dẫn:** `/courses/:courseId?tab=instructor`
- **Asset:** [course/Couser04_3CourseDetailInstructorPreviewTab.svg](../../screen/course/Couser04_3CourseDetailInstructorPreviewTab.svg)
